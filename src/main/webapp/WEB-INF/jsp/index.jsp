...
<header>  <div id="zagolovok">Узнавай о событиях космоса и спеши наблюдать</div>
...
<div id="content">
 ...
 <c:forEach items="${events}" var="events">
        ...
        <div class="event-date"> "${eventDame}" </div>
        <div class="evenr-conent"><c:out value="${eventDescription}"/></div>
        </div>
...
<div class="evenr-content">На этой неделе Меркурий достигнет наибольшей вечерней элонгации в 18°, а главным событием неба станет близкий пролет околоземного астероида 2012 DA14 (+7m) в ночь с 15 на 16 февраля. Сатурн наблюдаются на ночном и утреннем небе, Юпитер виден с вечера до ночи, Уран - на вечернем небе, а Меркурий и Марс - на вечерней заре. Венера и Нептун не видны...</div>
</div>
...
<div class="event-creator">новость добавил Mihail@1988</div>
<div class="evenr-content">Звездообразная галактика М82 (галактика &quot;сигара&quot;) одна из наиболее изученных галактик ночного неба. Известно, что M82 — это неправильная галактика. Также считается, что на неё сильно повлиял &quot;недавний&quot; пролёт мимо (своей соседки),большой спиральной галактики M81...</div>
</div>
